...
class cFrozenPlayer {
	...
	void think() {
		...
		while(true) {
			@target = @G_FindEntityInRadius(target, stop, origin, FTAG_DEFROST_RADIUS);
...
bool FTAG_LastAlive(cClient @client) {
...
bool FTAG_PlayerFrozen(cClient @client) {
	return @FTAG_GetFrozenForPlayer(client) != null;
}

cFrozenPlayer @FTAG_GetFrozenForPlayer(cClient @client) {
	for(cFrozenPlayer @frozen = @frozenHead; @frozen != null; @frozen = @frozen.next) {
